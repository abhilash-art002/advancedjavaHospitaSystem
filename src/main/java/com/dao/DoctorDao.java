...
public class DoctorDao {
	...
	public boolean registerDoctor(Doctor d)
	{
		...
		try {
			...
			String sql="INSERT INTO doctor ( full_name, dob, qualifiaction, specialist, email, mobile, password) VALUES (?,?,?,?,?,?,?)";
	 ...
	 public boolean updateDoctor(Doctor d)
		{
			...
			try {
				...
				String sql="update doctor set full_name=?, dob=?, qualifiaction=?, specialist=?, email=?, mobile=?, password=? where id=?";
				PreparedStatement ps=conn.prepareStatement(sql);
				ps.setString(1, d.getFullname());
				ps.setString(2, d.getDob());
				ps.setString(3, d.getQualification());
	 ...
	 public boolean checkOldPassword(int userId,String oldpassword) {
		...
		public boolean editDoctorProfile(Doctor d)
		{
			...
			try {
				...
				String sql="update doctor set full_name=?, dob=?, qualifiaction=?, specialist=? mobile=? where id=?";
				PreparedStatement ps=conn.prepareStatement(sql);
				ps.setString(1, d.getFullname());
				ps.setString(2, d.getDob());
				ps.setString(3, d.getQualification());
